    ...
    (e = function() {
        ...
        return function(t, o) {
            ...
            n.defaults = {
                accessibility: !0,
                adaptiveHeight: !1,
                appendArrows: $('.wsp24-arrow'),
                appendDots: i(t),
                arrows: !0,
                asNavFor: null,
                prevArrow: '<button class="slick-prev col-4" aria-label="Previous" type="button">Previous</button>',
                nextArrow: '<button class="slick-next col-4" aria-label="Next" type="button">Next</button>',
                autoplay: !1,
                autoplaySpeed: 3e3,
                centerMode: !1,
                centerPadding: "50px",
