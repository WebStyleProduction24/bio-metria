...
function main_menu()
{
	wp_nav_menu( [
		...
		'walker'          => new wp_main_menu,
	] );
}


class wp_main_menu extends Walker_Nav_Menu  {
...
class wp_footer_menu extends Walker_Nav_Menu  {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$class_names = ' class="footer-list__item"';
		...
		$item_output  = $args->before;
		$item_output .= '<a class="footer-list__link"' . $attributes . '>';
		$item_output .= $args->link_before . $title . $args->link_after;
		$item_output .= '</a>';
		$item_output .= $args->after;
